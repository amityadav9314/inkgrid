    ...
    <FooterContainer>
      <FooterContent>
        <FooterSection>
          ...
          <FooterDescription>
            Transform your photos into stunning mosaic artworks with our powerful yet simple tool.
          </FooterDescription>
        </FooterSection>
        ...
        <FooterNav>
          ...
          <FooterNavColumn>
            <FooterNavTitle>Legal</FooterNavTitle>
            <FooterNavList>
              <FooterNavItem>
      ...
      <FooterBottom>
        <FooterCopyright>
          &copy; {new Date().getFullYear()} InkGrid. All rights reserved.
        </FooterCopyright>
