...
const MainImageSelector: React.FC<MainImageSelectorProps> = ({ projectId }) => {
  ...
  const handleUpload = async (files: File[]) => {
    ...
    try {
      ...
      const imagePath = config.getImageUrl(response.path);

      setMainImage({
        id: response.id,
        path: imagePath, // Use the formatted path with base URL
      ...
      console.error('HandleUpload: Error uploading main image:', error);
